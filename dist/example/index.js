...
const MarkdownService_1 = require("../src/documentation/service/markdown/MarkdownService");
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        const projectPath = './project';
        const markdownService = new MarkdownService_1.MarkdownService(projectPath);
