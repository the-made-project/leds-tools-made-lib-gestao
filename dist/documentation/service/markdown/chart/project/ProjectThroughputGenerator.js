...
exports.ProjectThroughputGenerator = void 0;
    ...
    processData() {
        ...
        while (currentDate <= endDate) {
            ...
            days.push({
                ...
                inProgress: allTasksUntilDay.filter(task => task.status === "IN_PROGRESS" || task.status === "DOING").length,
...
exports.ProjectThroughputGenerator = ProjectThroughputGenerator;
