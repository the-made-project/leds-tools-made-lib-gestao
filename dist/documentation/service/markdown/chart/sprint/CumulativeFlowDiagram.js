...
exports.CumulativeFlowDiagram = void 0;
    ...
    processData() {
        try {
            ...
            while (currentDate <= endDate) {
                ...
                days.push(Object.assign({ day: `${weekDay} ${formattedDate}`, date: new Date(currentDate) }, statusCounts));
...
exports.CumulativeFlowDiagram = CumulativeFlowDiagram;
