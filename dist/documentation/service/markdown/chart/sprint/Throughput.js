...
exports.ThroughputGenerator = void 0;
const fs = __importStar(require("fs"));
class ThroughputGenerator {
    constructor(sprintData, outputPath = './throughput.svg') {
        if (!sprintData) {
        ...
        try {
            ...
            while (currentDate <= endDate) {
                ...
                days.push({
                    ...
                    inProgress: issuesUntilDay.filter(issue => issue.status === "IN_PROGRESS" || issue.status === "DOING").length,
...
exports.ThroughputGenerator = ThroughputGenerator;
