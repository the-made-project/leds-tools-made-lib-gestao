...
var MarkdownService_1 = require("../src/documentation/service/markdown/MarkdownService");
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var projectPath, markdownService;
        return __generator(this, function (_a) {
            projectPath = './project';
            markdownService = new MarkdownService_1.MarkdownService(projectPath);
